        ...
        (() => {
          ...
          return (
            <div style={styles.modalBackdrop} onClick={() => setViewingUser(null)}>
              <div style={{ ...styles.modalPanel, maxWidth: 720, maxHeight: "95vh" }} onClick={(e) => e.stopPropagation()}>
                <div className="nur-menu-smoke" />
                <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", maxHeight: "95vh" }}>
