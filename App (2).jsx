...
export default function App() {
  ...
  }, [session, refreshFriends, refreshTeamInvites, refreshSupportTickets, refreshSupportArchive, refreshReadyChecks, refreshMatchVetoes]);
  ...
  }, [refreshTeams, refreshTournaments, refreshAllMatches, refreshReadyChecks, refreshMatchVetoes, refreshAds, refreshStaffProfiles]);
  ...
  return (
    <div style={styles.page}>
      ...
      {(() => {
        ...
        return (
          <div style={styles.readyCheckOverlay}>
            <div style={{ ...styles.readyCheckCard, maxWidth: 460 }}>
              <div style={{ ...styles.hint, marginBottom: 6 }}>Бан карт</div>
              <div style={{ fontSize: 15, fontWeight: 700, color: "#F3ECEA", marginBottom: 14, textAlign: "center" }}>
                {myTeam ? teamLabel(myTeam) : "Вы"} vs {oppTeam ? teamLabel(oppTeam) : "Соперник"}
              </div>
              {myVeto.status === "completed" ? (
                <>
                  <div style={{ ...styles.hint, marginBottom: 8 }}>Карта определена:</div>
                  <div style={{ fontSize: 22, fontWeight: 700, color: "#E8A33D" }}>{MAP_LABEL[myVeto.final_map] || myVeto.final_map}</div>
                </>
              ) : (
                <>
                  <div style={{ ...styles.hint, marginBottom: 14, textAlign: "center" }}>
                    {!isCaptain
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            borderColor: clickable ? "#D9414C" : undefined,
                          }}
                        >
                          {MAP_LABEL[mapKey]}
                        </button>
