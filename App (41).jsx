...
const styles = {
  ...
  modeBtn: { background: "linear-gradient(180deg, rgba(255,255,255,0.05), rgba(255,255,255,0.01))", border: "1px solid #3D2226", borderRadius: 10, color: "#AE9B99", fontSize: 12, fontFamily: "'JetBrains Mono', monospace", letterSpacing: 1, padding: "11px 14px", cursor: "pointer", position: "relative", zIndex: 2 },
