...
export default function App() {
  ...
  const renderBracket = (tournamentId, rounds, interactive) => {
    ...
    return (
      <div className="nur-bracket-scroll" style={{ overflowX: "auto", paddingTop: 46, paddingBottom: 10 }}>
                          ...
                          >
                            ...
                            >
                              {isBye ? null : m.winner_id ? (
                                ...
                                <>
                                  <span style={{ fontFamily: "'Anton', sans-serif", fontSize: 10, lineHeight: 1, color: "#9FD4EE" }}>V</span>
                                  <span style={{ fontFamily: "'Anton', sans-serif", fontSize: 10, lineHeight: 1, color: "#9FD4EE", marginTop: 3 }}>S</span>
                                </>
                              )}
                            </div>
                          </div>
