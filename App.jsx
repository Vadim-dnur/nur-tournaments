        ...
        (() => {
          ...
          return (
            <div style={styles.modalBackdrop} onClick={() => setViewingUser(null)}>
              <div style={{ ...styles.modalPanel, maxWidth: 560, maxHeight: "88vh" }} onClick={(e) => e.stopPropagation()}>
                <div className="nur-menu-smoke" />
                <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", maxHeight: "88vh" }}>
                  <div style={styles.profileBannerBase}>
                  ...
                  <div style={{ padding: "0 24px", flex: 1, overflow: "auto" }}>
                    <div style={{ ...styles.avatarWrap, width: 84, height: 84, marginTop: -20, border: "3px solid #180F10", borderRadius: "50%", background: "#180F10" }}>
