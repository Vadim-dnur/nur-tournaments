        ...
        return (
          <div style={styles.readyCheckOverlay}>
            ...
            <div style={{ ...styles.readyCheckCard, maxWidth: 900, background: "transparent", border: "none", boxShadow: "none", padding: 0, position: "relative" }}>
              ...
              <div style={{ display: "flex", gap: 16, overflowX: "auto", padding: "10px 4px 16px", position: "relative", zIndex: 1 }}>
                {MAP_POOL.map((mapKey) => {
...
const styles = {
  ...
  vetoBgNur: { color: "rgba(255,255,255,0.055)" },
  vetoBgTour: { color: "transparent", WebkitTextStroke: "1.5px rgba(255,255,255,0.06)" },
  vetoTurnLabel: {
    fontFamily: "'JetBrains Mono', monospace",
    fontSize: 13,
    fontWeight: 700,
