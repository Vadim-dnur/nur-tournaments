            ...
            <div style={styles.heroSide}>
              {countdownParts ? (
                ...
                <>
                  ...
                  <button className="nur-btn" style={{ ...styles.accentBtnSm, marginTop: 16 }} onClick={() => toggleExpand(featuredTour.id, true)}>
                    Смотреть сетку
                  </button>
                </>
              ) : (
                <>
                  ...
                  <a
                    ...
                    className="nur-btn"
                    style={{ ...styles.ghostBtnSm, textDecoration: "none", marginTop: 16, display: "inline-flex" }}
                  >
                    Открыть канал
                  </a>
                </>
                  ...
                  <div key={l.id} style={{ ...styles.homeMatchCard, borderColor: "#5A2E33", background: "#140E10" }}>
                    ...
                    <div style={styles.matchRow}>
                      <div style={styles.matchSideL}>
                        <span style={styles.matchTeam}>{shortTeamName(teamMap[l.team1_id])}</span>
                      </div>
                      <span style={styles.matchVs}>VS</span>
                      <div style={styles.matchSideR}>
                        <span style={{ ...styles.matchTeam, textAlign: "right" }}>{shortTeamName(teamMap[l.team2_id])}</span>
                      </div>
                    </div>
                    ...
                    <div key={m.id} style={styles.homeMatchCard}>
                      ...
                      <div style={styles.matchRow}>
                        <div style={{ ...styles.matchSideL, borderLeft: t1Won ? "3px solid #E8A33D" : "3px solid transparent" }}>
                          <span style={{ ...styles.matchTeam, color: t1Won ? "#F3ECEA" : "#8C7876" }}>{shortTeamName(teamMap[m.team1_id])}</span>
                        </div>
                        ...
                        <div style={{ ...styles.matchSideR, borderRight: !t1Won ? "3px solid #E8A33D" : "3px solid transparent" }}>
                          <span style={{ ...styles.matchTeam, textAlign: "right", color: !t1Won ? "#F3ECEA" : "#8C7876" }}>
                            {shortTeamName(teamMap[m.team2_id])}
                          </span>
                        </div>
                      </div>
...
const styles = {
  ...
  heroGrid: { display: "grid", gridTemplateColumns: "minmax(0, 1.45fr) minmax(260px, 0.85fr)", gap: 12, alignItems: "stretch" },
  heroGhost: {
    position: "absolute",
    right: -18,
    top: -34,
  ...
  // ---------- Бегущая строка результатов ----------
  tickerWrap: { marginTop: 12, borderRadius: 10, overflow: "hidden", background: "#D9414C", padding: "7px 0" },
  ...
  secNum: { fontFamily: "'JetBrains Mono', monospace", fontSize: 11, fontWeight: 700, color: "#D9414C" },
  ...
  matchSideL: { flex: 1, minWidth: 0, background: "#1A1315", padding: "9px 10px", borderRadius: 4 },
  matchSideR: { flex: 1, minWidth: 0, background: "#1A1315", padding: "9px 10px", borderRadius: 4 },
  matchTeam: {
    display: "block",
    fontFamily: "'Anton', sans-serif",
    fontSize: 13,
