                ...
                <div style={{ ...styles.card, padding: 0, overflow: "hidden" }}>
                  ...
                  <div style={{ padding: "0 18px 18px" }}>
                    <div style={{ display: "flex", alignItems: "flex-end", gap: 14, marginTop: -30 }}>
                      <div style={{ ...styles.avatarWrap, width: 68, height: 68, border: "3px solid #150F10", borderRadius: "50%", background: "#150F10" }}>
                        {profile?.avatar_url ? (
        ...
        (() => {
          ...
          return (
            <div style={styles.modalBackdrop} onClick={() => setViewingUser(null)}>
              <div style={{ ...styles.modalPanel, maxWidth: 420 }} onClick={(e) => e.stopPropagation()}>
                <div className="nur-menu-smoke" />
                <div style={{ position: "relative", zIndex: 1 }}>
                  <div style={styles.profileBannerBase}>
                  ...
                  <div style={{ padding: "0 20px 20px" }}>
                    <div style={{ ...styles.avatarWrap, width: 76, height: 76, marginTop: -34, border: "3px solid #180F10", borderRadius: "50%", background: "#180F10" }}>
                      {viewingUser.avatar_url ? (
                        <img src={viewingUser.avatar_url} alt="" style={{ ...styles.avatarImg, width: 70, height: 70 }} />
                      ) : (
                        <div style={{ ...styles.avatarFallback, width: 70, height: 70 }}>{(viewingUser.username || "?")[0].toUpperCase()}</div>
                      )}
                    </div>
                    <div style={{ marginTop: 10, fontFamily: "'Anton', sans-serif", fontSize: 19, color: "#F3ECEA" }}>{viewingUser.username}</div>
                    <div style={{ marginTop: 16 }}>
                      <div style={{ ...styles.hint, marginBottom: 8 }}>Команды:</div>
                      {userTeams.length === 0 ? (
