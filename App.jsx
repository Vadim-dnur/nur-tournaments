      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        @keyframes nur-drip-fall {
          0%   { opacity: 0; height: 6px; transform: translateY(0) scaleY(1); }
          10%  { opacity: 1; height: 7px; transform: translateY(0) scaleY(1.05); }
          28%  { height: 16px; transform: translateY(1px) scaleY(1.35); }
          40%  { height: 22px; transform: translateY(4px) scaleY(1.55); }
          52%  { height: 10px; transform: translateY(16px) scaleY(1.1); opacity: 1; }
          62%  { height: 8px; transform: translateY(24px) scaleY(1); opacity: 0.9; }
          78%  { height: 7px; transform: translateY(34px) scaleY(0.9); opacity: 0.5; }
          92%  { opacity: 0.08; transform: translateY(42px); }
          100% { opacity: 0; height: 6px; transform: translateY(0) scaleY(1); }
        }
        .nur-drip {
          position: absolute;
          top: 0;
...
const styles = {
  ...
  heroTitleText: {
    ...
    letterSpacing: 3,
    color: "#C4222E",
    textShadow: "0 0 18px rgba(196,34,46,0.5)",
  },
  heroSmoke: {
    position: "absolute",
    inset: 0,
