...
export default function App() {
  ...
  useEffect(() => {
    ...
    supabase
      .from("profiles")
      .select("username, is_admin, is_moderator, avatar_url, banner_url, bio")
  ...
  const openUserProfile = async (user) => {
    ...
    const { data: fullProfile } = await supabase
      .from("profiles")
      .select("id, username, avatar_url, banner_url, bio, is_moderator")
      .eq("id", user.id)
      .single();
      ...
      {supportPanelOpen && (
        <div style={styles.supportPanel}>
          <div style={styles.chatHeader}>
            {supportView === "list" ? (
              ...
              <div style={{ flex: 1, minWidth: 0, display: "flex", alignItems: "center", gap: 8 }}>
                {(profile?.is_admin || profile?.is_moderator) && (
                  <button style={styles.iconBtn} onClick={openSupportList}>
            ...
            <button style={styles.iconBtn} onClick={() => setSupportPanelOpen(false)}>
              <X size={14} color="#AE9B99" />
            </button>
          </div>
