        ...
        (() => {
          ...
          return (
            <div style={styles.modalBackdrop} onClick={() => setViewingUser(null)}>
              <div style={{ ...styles.modalPanel, maxWidth: 720, maxHeight: "92vh" }} onClick={(e) => e.stopPropagation()}>
                <div className="nur-menu-smoke" />
                <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", maxHeight: "92vh" }}>
                  <div style={styles.profileBannerBase}>
