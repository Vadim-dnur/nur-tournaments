...
export default function App() {
  ...
  const createTeam = async () => {
    ...
    if (containsNonLatin(teamName) || containsNonLatin(teamTag)) {
      return setErrorMsg("Название и тег команды можно писать только английскими буквами и цифрами.");
    }
  ...
  return (
    <div style={styles.page}>
      ...
      {session && profile && !profile.agreed_rules_at && (
        <div style={styles.readyCheckOverlay}>
          <div style={{ ...styles.readyCheckCard, maxWidth: 560, maxHeight: "82vh", overflowY: "auto", textAlign: "left" }}>
