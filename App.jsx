...
export default function App() {
  ...
  const playTypeSound = () => {
    ...
    try {
      ...
      osc.type = "sine";
      osc.frequency.value = 720 + Math.random() * 80;
                ...
                <div style={{ ...styles.card, padding: 0, overflow: "hidden" }}>
                  ...
                  <div style={{ padding: "0 18px 18px" }}>
                    ...
                    <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 10 }}>
                      ...
                      <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12.5, color: "#AE9B99", cursor: "pointer" }}>
                        <input type="checkbox" checked={typeSoundOn} onChange={toggleTypeSound} />
                        Звук при печати текста
                      </label>
                      <div>
